...
export type GameState = 'mode_selection' | 'data_management' | 'recruitment_sub_selection' | 'hiring_recommendation_results' | 'input' | 'mbti_quiz' | 'loading' | 'results' | 'team_building_selection' | 'team_building_analysis' | 'team_building_results' | 'error';
