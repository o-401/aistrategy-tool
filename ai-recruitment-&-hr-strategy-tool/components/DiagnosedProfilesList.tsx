...
interface DiagnosedProfilesListProps {
  ...
  onAnalyze: (purpose: string, industry: string, teamSize: number) => void;
}
...
export const DiagnosedProfilesList: React.FC<DiagnosedProfilesListProps> = ({ profiles, onRemove, onAnalyze }) => {
  ...
  const handleAnalyzeClick = () => {
    onAnalyze(selectedPurpose, industry, teamSize);
  };
        ...
        <div className="mt-4">
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="industry" className="block text-sm font-medium text-slate-600 mb-1">2. 業種は？</label>
                  ...
                  <div>
                    <label htmlFor="team-size" className="block text-sm font-medium text-slate-600 mb-1">3. チーム人数は？</label>
                    <input
                      type="number"
                      id="team-size"
                      value={teamSize}
