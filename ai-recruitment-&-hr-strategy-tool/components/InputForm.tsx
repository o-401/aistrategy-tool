      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {appMode === 'individual' && (
          <div className="space-y-4 pt-2">
             <SelectInput label="あなたの業種（任意）" value={formData.industry || '指定なし'} onChange={handleChange('industry')} options={industries} />
            <TextAreaInput
        ...
        {appMode === 'recruitment' && (
          <div className="space-y-4 pt-2">
            <SelectInput label="企業・候補者の業種（任意）" value={formData.industry || '指定なし'} onChange={handleChange('industry')} options={industries} />
            <TextAreaInput 
              label="企業情報（任意）"
