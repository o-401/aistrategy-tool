...
/**
 * Safely parses a JSON string, cleaning it of markdown fences first.
 * @param jsonString The raw string from the AI response.
 * @returns The parsed JSON object.
 */
export const parseJsonResponse = <T>(jsonString: string): T => {
    ...
    try {
        ...
        throw new Error("AIからの応答を解析できませんでした。AIの応答が不完全か、形式が正しくない可能性があります。");
    }
};
